...
import { useGetAggregatorTransferBetweenAccountsReports } from "@src/services/reports/moviments/aggregator/getTransferBetweenAccountsReports";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const AggregatorTransferBetweenAccountsReports = () => {
  ...
  } = useGetAggregatorTransferBetweenAccountsReports(query);
    ...
    <Grid container style={{ padding: "25px" }}>
      ...
      >
        ...
        >
          ...
          >
            {!isTransferBetweenAccountsReportsDataFetching && <ReloadOutlined />}
          </Button>
        </Grid>
      </Grid>
