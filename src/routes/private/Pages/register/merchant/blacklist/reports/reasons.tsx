...
import { useGetMerchantBlacklistReasons } from "@src/services/register/merchant/blacklist/getBlacklistReasonsCsv";

export const MerchantBlacklistReasonsReports = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useGetMerchantBlacklistReasons(query);
