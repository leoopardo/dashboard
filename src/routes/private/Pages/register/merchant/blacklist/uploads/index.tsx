...
import { useGetMerchantBlacklistUploads } from "@src/services/register/merchant/blacklist/getBlacklistUploads";
import {
...
export const MerchantsBlacklistUploads = () => {
  ...
  const { data, error, isFetching, refetch } =
    useGetMerchantBlacklistUploads(query);
