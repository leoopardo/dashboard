...
import { useGetPartnerUsersReports } from "@src/services/reports/register/partner/getPartnerUserReports";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const PartnerUsersReports = () => {
  ...
  } = useGetPartnerUsersReports(query);
    ...
    <Grid container style={{ padding: "25px" }}>
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
           <Button size="large"
            style={{ width: "100%" }}
            loading={isPartnerUsersReportsDataFetching}
            type="primary"
        ...
        <Grid item xs={12} md="auto">
          <Button
            ...
            shape="round"
            type="dashed"
            onClick={refetchPartnerUsersReportsData}
          >
            {!isPartnerUsersReportsDataFetching && <ReloadOutlined />}
          </Button>
        </Grid>
      </Grid>
      ...
      <Grid container style={{ marginTop: "15px" }}>
        <Grid item xs={12}>
          ...
          <CustomTable
            ...
            data={PartnerUsersReportsData}
            items={PartnerUsersReportsData?.items}
            error={PartnerUsersReportsDataError}
            columns={[
