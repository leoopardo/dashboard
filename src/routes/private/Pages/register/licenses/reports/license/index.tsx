...
import { useGetLicensesReports } from "@src/services/reports/register/license/getLicenseReports";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const LicenseReports = () => {
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
          <Button
            size="large"
            style={{ width: "100%" }}
            loading={isLicenseReportsDataFetching}
            type="primary"
      ...
      <Grid container style={{ marginTop: "15px" }}>
        <Grid item xs={12}>
          <CustomTable
            ...
            refetch={refetchLicenseReportsData}
            data={LicenseReportsData}
            items={LicenseReportsData?.items}
            error={LicenseReportsDataError}
            columns={[
