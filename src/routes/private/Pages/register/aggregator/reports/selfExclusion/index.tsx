...
import { useGetSelfExclusionReports } from "@src/services/reports/register/aggregators/getSelfExclusionReports";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const SelfExclusionReports = () => {
  ...
  } = useGetSelfExclusionReports(query);
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
          <Button
            size="large"
            style={{ width: "100%" }}
            loading={isSelfExclusionReportsDataFetching}
            type="primary"
        ...
        <Grid item xs={12} md="auto">
          <Button
            ...
            shape="round"
            type="dashed"
            onClick={refetchSelfExclusionReportsData}
          >
            {!isSelfExclusionReportsDataFetching && <ReloadOutlined />}
          </Button>
        </Grid>
      </Grid>
