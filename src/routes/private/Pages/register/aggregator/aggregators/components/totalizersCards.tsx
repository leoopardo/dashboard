...
import { AggregatorQuery, AggregatorsTotalResponse } from "@src/services/types/register/aggregators/aggregators.interface";
    ...
    <Grid container spacing={1} justifyContent={"center"} mb={2}>
      <Grid item xs={12} md="auto">
        <Card bordered={false}>
          <Statistic
            ...
            title={t("titles.total_registred", {entity: t('menus.aggregator')?.toLowerCase()})}
      ...
      <Grid item xs={12} md="auto">
        <Card bordered={false}>
          <Statistic
            loading={props?.loading}
            title={t("titles.total_registred_active", {entity: t('menus.aggregator')?.toLowerCase()})}
            style={{ maxWidth: 200, minHeight: 75 }}
      ...
      <Grid item xs={12} md="auto">
        <Card bordered={false}>
          <Statistic
            loading={props?.loading}
            title={t("titles.total_registred_inactive", {entity: t('menus.aggregator')?.toLowerCase()})}
            style={{ maxWidth: 200, minHeight: 75 }}
      ...
      <Grid item xs={12} md="auto">
        <Card bordered={false}>
          <Statistic
            loading={props?.loading}
            title={t("titles.total", {entity: t('menus.operators')?.toLowerCase()})}
            style={{ maxWidth: 200, minHeight: 75 }}
