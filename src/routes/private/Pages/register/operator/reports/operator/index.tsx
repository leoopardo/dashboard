...
import { useGetOperatorsReports } from "@src/services/reports/register/operator/getOperatorReports";
    ...
    <Grid container style={{ padding: "25px" }}>
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
           <Button size="large"
            style={{ width: "100%" }}
            loading={isOperatrsReportsDataFetching}
            type="primary"
        ...
        <Grid container item xs={12} md="auto" lg={1} style={{marginLeft: 'auto'}}>
          <Button
            style={{
              width: "100%",
              height: 40,
            ...
            shape="round"
            type="dashed"
            onClick={refetchOperatrsReportsData}
          >
            {!isOperatrsReportsDataFetching && <ReloadOutlined />}
          </Button>
        </Grid>
      </Grid>
