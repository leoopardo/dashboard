...
import { useGetPaidWithdrawalsReports } from "@src/services/reports/consult/withdrawals/paid/getPaidWithdrawals";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const PaidWithdrawalsReports = () => {
  ...
  } = useGetPaidWithdrawalsReports(query);
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
          <Button
            size="large"
            style={{ width: "100%" }}
            loading={isPaidWithdrawalsReportsDataFetching}
            type="primary"
