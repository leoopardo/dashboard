...
import { useGetGeneratedWithdrawalsReports } from "@src/services/reports/consult/withdrawals/generated/getGeneratedWithdrawals";
import { ReportsQuery } from "@src/services/types/reports/reports.interface";
import { Button } from "antd";
import { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";

export const GeneratedWithdrawalsReports = () => {
  ...
  } = useGetGeneratedWithdrawalsReports(query);
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
          <Button
            size="large"
            style={{ width: "100%" }}
            loading={isGeneratedWithdrawalsReportsDataFetching}
            type="primary"
      ...
      <Grid container style={{ marginTop: "15px" }}>
        <Grid item xs={12}>
          <CustomTable
            ...
            refetch={refetchGeneratedWithdrawalsReportsData}
            data={GeneratedWithdrawalsReportsData}
            items={GeneratedWithdrawalsReportsData?.items}
            error={GeneratedWithdrawalsReportsDataError}
            columns={[
              { name: "_id", type: "id" },
