...
export const RefundWithdrawalsReports = () => {
  ...
  } = useGetRefundWithdrawalsReports(query);
      ...
      >
        <Grid item xs={12} md={4} lg={2}>
          <Button
            size="large"
            style={{ width: "100%" }}
            loading={isRefundWithdrawalsReportsDataFetching}
            type="primary"
      ...
      <Grid container style={{ marginTop: "15px" }}>
        <Grid item xs={12}>
          <CustomTable
            ...
            refetch={refetchRefundWithdrawalsReportsData}
            data={RefundWithdrawalsReportsData}
            items={RefundWithdrawalsReportsData?.items}
            error={RefundWithdrawalsReportsDataError}
            columns={[
              { name: "_id", type: "id" },
