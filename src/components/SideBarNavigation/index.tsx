...
export const SidebarNavigation = () => {
  ...
  const { permissions, type, id } = queryClient.getQueryData(
    "validate"
      ...
      getItem(
        ...
        [
          ...
          getItem(
            ...
            [
              ...
              getItem(
                ...
                false,
                {
                  display: permissions?.register?.paybrokers?.banks_maintain
                    ?.menu
                    ? undefined
                    : "none",
                },
              ...
              getItem(
                ...
                [
                  ...
                  getItem(
                    ...
                    false,
                    {
                      display: permissions?.register?.paybrokers
                        ?.release_category
          ...
          getItem(
            ...
            false,
            {
              display: permissions?.register?.partner?.menu
                ? undefined
                : "none",
            }
          ),
          ...
          getItem(
            ...
            false,
            {
              display: permissions?.register?.operator?.menu
                ? undefined
                : "none",
            }
          ),
          ...
          getItem(
            ...
            [
              ...
              getItem(
                ...
                false,
                {
                  display: permissions?.register?.merchant?.release_category
                    ?.menu
                    ? undefined
                    : "none",
                },
            ...
            false,
            {
              display: permissions?.register?.merchant?.menu
                ? undefined
                : "none",
            }
          ),
                ...
                [
                  ...
                  getItem(
                    ...
                    <Link
                      ...
                      title={`${t(
                        "menus.merchant_pre_manual_moviments_import"
                      )}`}
                    >
      ...
      getItem(
        ...
        [
          ...
          getItem(
            ...
            false,
            {
              display: permissions?.report?.paybrokers?.menu
                ? undefined
                : "none",
            }
          ),
          ...
          getItem(
            ...
            [
              ...
              getItem(
                ...
                false,
                {
                  display: permissions?.report?.deposit?.undelivered_deposit
                    ?.menu
                    ? undefined
                    : "none",
                },
          ...
          getItem(
            ...
            false,
            {
              display: permissions?.report?.chargeback?.menu
                ? undefined
                : "none",
            }
          ),
          ...
          getItem(
            ...
            [
              ...
              getItem(
                ...
                false,
                {
                  display: permissions?.support?.blacklist?.invalid_pix_keys
                    ?.menu
                    ? undefined
                    : "none",
                },
            ...
            false,
            {
              display: permissions?.support?.blacklist?.menu
                ? undefined
                : "none",
            }
          ),
