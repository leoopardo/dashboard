      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                key: "persons_cnpj_persons_reports",
                label: "person_persons_reports",
                path: "/register/person/legal_person_reports/legal_persons",
                permission:
                  permissions?.register?.person?.person
                    ?.person_person_export_csv,
              },
              {
                key: "person_cnpj_client_bank_reports",
                label: "client_bank_reports",
                path: "/register/person/person_reports/client_bank_reports",
                permission:
                  permissions?.register?.person?.client_banks
