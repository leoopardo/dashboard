...
export function useGetTransferBetweenAccountsReports(params: ReportsQuery) {
  ...
  >(
    "MerchantTransferBetweenAccountsReports",
    async () => {
      const response = await api.get("core/csv/merchant/account/balance/transfer", {
        params,
      });
