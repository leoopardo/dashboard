...
export function useCreateManualEntryCategory(body: MerchantManualEntryCategoryItem | null) {
  const { isLoading, error, mutate, isSuccess } = useMutation<
    MerchantManualEntryCategoryItem | null | undefined
  >("CreateMerchantManualEntryCategory", async () => {
    const response = await api.post("core/entry-account/create/category", body, {});
